 ...
 * sequences, a tail call lands after the callee's frame setup, and private
 * stacks are allocated from the program's own depth, so MAX_BPF_STACK_JIT
 * frames need nothing special.
 */
